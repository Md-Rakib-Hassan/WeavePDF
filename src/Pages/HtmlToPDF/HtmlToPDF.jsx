        ...
        <div className="hero min-h-[70vh] bg-base-200">
            <div className="hero-content text-center">
                <div className="max-w-lg">
                    ...
                    <p className="py-6">Transform web pages into PDF files with precision and reliability.</p>
            ...
            <div className="modal" role="dialog">
                <div className="modal-box">
                    <div className="modal-action">
                        <label htmlFor="my_modal_6" className="btn font-bold rounded-full">X</label>
                    </div>
                    <h1 className="text-center text-2xl font-bold">Add HTML to convert from</h1>
                    <form className="card-body border-2 mt-3">
                    ...
                    <form className="card-body border-2 mt-2">
                        <div className="form-control">
                            <span className="label-text my-3 font-bold">Select Your HTML FIle</span>
