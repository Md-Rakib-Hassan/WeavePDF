        ...
        <div className='my-20'>
            ...
            <div className="flex justify-center">
                <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-10 my-7 text-center">
                    ...
                    <Link to='/htmlToPdf'><div className="flex flex-col items-center justify-center bg-slate-100 py-3 w-[250px] lg:w-[150px] h-[150px] rounded-lg hover:scale-110 ease-in-out">
