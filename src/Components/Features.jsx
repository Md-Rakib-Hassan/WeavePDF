        ...
        <div className='my-20'>
            ...
            <div className="flex justify-center">
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-10 my-7 text-center">
                    ...
                    <Link to={'/pdf-editor'}><div className="flex flex-col items-center justify-center bg-blue py-3 w-[250px] lg:w-[150px] h-[150px] rounded-lg hover:scale-110 ease-in-out">
                        <FaFilePen className="text-6xl"></FaFilePen>
                        <h1 className="font-bold text-xl">PDF Editor</h1>
                    </div></Link>
                    {/* not finish yet */}
                    {/* <Link to="/pdf-signature"><div className="flex flex-col items-center justify-center bg-blue py-3 w-[250px] lg:w-[150px] h-[150px] rounded-lg hover:scale-110 ease-in-out">
                        <FaFileSignature className="text-6xl"></FaFileSignature>
                        <h1 className="font-bold text-xl">PDF Signature</h1>
                    </div></Link> */}
